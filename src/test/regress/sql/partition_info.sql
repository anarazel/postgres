...
CREATE TABLE ptif_p1 PARTITION OF pt FOR VALUES FROM (1) to (2) PARTITION BY RANGE (a);
CREATE TABLE ptif_p1_1 PARTITION OF ptif_p1 FOR VALUES FROM (1) TO (2);
CREATE UNIQUE INDEX ON ONLY ptif_p1 (a);
INSERT INTO ptif_p1 VALUES (1) ON CONFLICT (a) DO NOTHING;
