...
CREATE SCHEMA test_ns_schema_1
       CREATE UNIQUE INDEX ns_abc_a_idx ON ns_abc (a)

       CREATE VIEW ns_abc_view AS
              SELECT a+1 AS a, b+1 AS b FROM ns_abc
...
CREATE SCHEMA test_ns_schema_2
       CREATE VIEW ns_abc_view AS SELECT c FROM ns_abc;
COMMIT;
SHOW search_path;
...
SET search_path to public, test_ns_schema_1;
CREATE SCHEMA test_ns_schema_2
       CREATE VIEW ns_abc_view AS SELECT a FROM ns_abc;
SHOW search_path;
COMMIT;
SHOW search_path;
...
INSERT INTO test_ns_schema_1.ns_abc DEFAULT VALUES;
INSERT INTO test_ns_schema_1.ns_abc DEFAULT VALUES;
INSERT INTO test_ns_schema_1.ns_abc DEFAULT VALUES;

SELECT * FROM test_ns_schema_1.ns_abc;
SELECT * FROM test_ns_schema_1.ns_abc_view;
