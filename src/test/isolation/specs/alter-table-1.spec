...
#
# VALIDATE allows at1_a minimum of ShareUpdateExclusiveLock
# so we mix reads with it to see what works or waits

setup
{
 CREATE TABLE at1_a (i int PRIMARY KEY);
 CREATE TABLE at1_b (a_id int);
 INSERT INTO at1_a VALUES (0), (1), (2), (3);
 INSERT INTO at1_b SELECT generate_series(1,1000) % 4;
}

teardown
{
 DROP TABLE at1_a, at1_b;
}

session s1
step s1		{ BEGIN; }
step at1	{ ALTER TABLE at1_b ADD CONSTRAINT bfk FOREIGN KEY (a_id) REFERENCES at1_a (i) NOT VALID; }
step sc1	{ COMMIT; }
step s2		{ BEGIN; }
step at2	{ ALTER TABLE at1_b VALIDATE CONSTRAINT bfk; }
step sc2	{ COMMIT; }

session s2
setup		{ BEGIN; }
step rx1	{ SELECT * FROM at1_b WHERE a_id = 1 LIMIT 1; }
step wx		{ INSERT INTO at1_b VALUES (0); }
step rx3	{ SELECT * FROM at1_b WHERE a_id = 3 LIMIT 3; }
step c2		{ COMMIT; }
