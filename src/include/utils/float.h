 ...
 */
extern pg_noreturn void float_overflow_error(void);
extern pg_noreturn void float_underflow_error(void);
extern pg_noreturn void float_zero_divide_error(void);
