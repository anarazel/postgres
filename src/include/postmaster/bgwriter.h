...
extern pg_noreturn void BackgroundWriterMain(char *startup_data, size_t startup_data_len);
extern pg_noreturn void CheckpointerMain(char *startup_data, size_t startup_data_len);
